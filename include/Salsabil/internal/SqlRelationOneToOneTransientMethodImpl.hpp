...
namespace Salsabil {
    ...
    public:
        ...
        SqlRelationOneToOneTransientMethodImpl(const std::string& targetTableName, const std::string& targetColumnName, RelationType type, GetMethodType getter, SetMethodType setter) :
